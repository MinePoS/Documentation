...
1. Installing the Depends
   ...
   3. `apt update`
   4. `apt -y install php7.2 php7.2-cli php7.2-gd php7.2-mysql php7.2-pdo php7.2-mbstring php7.2-tokenizer php7.2-bcmath php7.2-xml php7.2-fpm php7.2-curl php7.2-zip curl tar unzip git`
2. Make a the directory for Minepos 
   1. `mkdir -p /var/www/minepos/`
